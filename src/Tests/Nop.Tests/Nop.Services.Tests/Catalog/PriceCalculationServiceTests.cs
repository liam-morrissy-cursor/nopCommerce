...
public class PriceCalculationServiceTests : ServiceTest
{
    ...
    [TestCase(1.225, 1.22, RoundingType.Rounding001)]
    [TestCase(2.005, 2.00, RoundingType.Rounding001)]
    [TestCase(2.015, 2.02, RoundingType.Rounding001)]
    [TestCase(12.365, 12.36, RoundingType.Rounding001)]
    ...
    [TestCase(12.35, 12.35, RoundingType.Rounding005Down)]
    ...
    [TestCase(12.05, 12.10, RoundingType.Rounding01Up)]
    ...
    [TestCase(12.05, 12.00, RoundingType.Rounding01Down)]
